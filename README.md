...
The two procedures that handle the conditional form are `` /if `` and `` /if1 ``. The former takes both a consequent and an alternate, the latter takes only a consequent.
