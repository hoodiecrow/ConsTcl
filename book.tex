...
\end{lstlisting}
\subsection{do-and procedure}
\label{do-and-procedure}
...
\end{lstlisting}
\subsection{do-cond procedure}
\label{do-cond-procedure}
...
\end{lstlisting}
\subsection{for-seq procedure}
\label{for-seq-procedure}
...
\end{lstlisting}
\subsection{do-for procedure}
\label{do-for-procedure}
...
\end{lstlisting}
\subsection{parse-bindings procedure}
\label{parse-bindings-procedure}
...
\end{lstlisting}
\subsection{do-or procedure}
\label{do-or-procedure}
