...
The \texttt{letrec} form is similar to \texttt{let}, but the bindings are created before the values for them are calculated. This means that the values can be mutually recursive.
...
Definition of letrec\footnote{See \texttt{https://docs.scheme.org/schintro/schintro\_126.html\#SEC161}}.
