...
\texttt{special-let} rewrites the named \texttt{let} and `regular' \texttt{let} forms. They are ultimately rewritten to \texttt{lambda} constructs and evaluated as such.
