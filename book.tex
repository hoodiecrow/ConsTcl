...
\texttt{rewrite-define} rewrites ``procedural define'' syntaxes to their equivalent forms with \texttt{lambda}, which unifies the syntaxes to (define \emph{symbol} \emph{value}). That syntax passes through \texttt{rewrite-define} unchanged.
