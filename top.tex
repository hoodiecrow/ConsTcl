...
In Lisp, everything is either a list expression, starting and ending with
parentheses and having an operator in the first position of the list, followed
by operands, or else an atomic (indivisible) expression like \texttt{x} or
\texttt{1}. A full description of Lisp is beyond the scope of this
introduction, but Lisp will be explained from the inside out in the rest of
this book.
